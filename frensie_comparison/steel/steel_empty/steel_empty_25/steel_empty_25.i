...
c
 ...
 3   3  -4.000000   -3 4                       $ Interior of shipping container
c
c
c //--- Highly Enriched Uranium Cells ---//
c
 4   3  -4.000000   -4                         $ HEU sphere (~10kg -> 5cm)
c
c
c //--- Tally Cells ---//
c
...
c
 4 1 SPH 0 0 0  5                              $ 5cm radius HEU sphere ~ 10kg U
c
...
c //--- Translations ---//
c
 TR1   -25 -25 -25                               $ Translation for HEU sphere
c
...
c
c * added by ADVANTG
wwp:n 5.0 j 100 j -1 0 9.751699300e-03